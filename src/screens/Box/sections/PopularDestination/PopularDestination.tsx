...
// import car from "../../../../assets/images/mdi_car.png";
// import medical_bag from "../../../../assets/images/mdi_medical-bag.png";
...
//             }}
//           >
//             <div className="relative rounded-lg shadow-lg items-center overflow-hidden w-[320px] h-[520px]">
//               {/* Background Image */}
//               <div
//                 className="w-full h-full bg-cover bg-center rounded-b-2xl"
//                 style={{ backgroundImage: `url(${card.image})` }}
//               >
//                 {/* Card Overlay */}
//                 <Card className="absolute bottom-0 w-full rounded-t-3xl bg-white shadow-lg">
...
//                         card.features.length > 4 ? "gap-3" : "gap-6"
//                       }`}
//                     >
//                       {card.features.map((feature, featureIndex) => {
//                         const iconSize =
...
//                             />
//                             <span
//                               className={`font-medium mt-1 ${textSize}`}
//                             >
//                               {feature.name}
//                             </span>
//                           </div>
